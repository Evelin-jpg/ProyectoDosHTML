...
<body style="background-color: #20B2AA; font-family: Italic; color:white">
<h2>AGREGA LOS DATOS:</h2>
    <center>
    <?php
        $enlace = mysqli_connect("localhost", "root", "", "tec");
        $query = "SELECT `IdAlumno`, `Nombre`, `Matricula`, `Correo`, `Tabla`, `Puntuacion` FROM `alumno`";
        ...
        <table class='table text-light'>
            <tr>
                ...
                <th scope='col-2'>Tabla</th>
                <th scope='col-2'>Puntuacion</th>
            </tr>";
        while($row = mysqli_fetch_assoc($result)) {
            ...
            <tr>
                ...
                <td>
                    <form action="frmEditar.php" method="post">
                        <input type="hidden" name="editar" value="'.$row["IdAlumno"].'">
                ...
                <td>
                    <form action="Eliminar.php" method="post">
                        <input type="hidden" name="borrar" value="'.$row["IdAlumno"].'">
